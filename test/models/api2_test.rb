...
class Api2Test < ActiveSupport::TestCase
  def test_from_json
    json = ActiveSupport::JSON.decode(File.read(Rails.root.join("test/fixtures/files/api2.json")))[0]
    ...
    assert_equal "https://d2ey9sqrvkqdfs.cloudfront.net/0qZF/2.jpg", api2.images.rooms.first.link
    assert_equal "Double room", api2.images.rooms.first.description
    assert_equal "https://d2ey9sqrvkqdfs.cloudfront.net/0qZF/4.jpg", api2.images.rooms.second.link
    assert_equal "Bathroom", api2.images.rooms.second.description
    assert_equal "https://d2ey9sqrvkqdfs.cloudfront.net/0qZF/0.jpg", api2.images.amenities.first.link
    assert_equal "RWS", api2.images.amenities.first.description
    assert_equal "https://d2ey9sqrvkqdfs.cloudfront.net/0qZF/6.jpg", api2.images.amenities.second.link
